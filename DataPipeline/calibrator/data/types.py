...
class HestonParameters:
    ...
    """
    mu: ParameterEstimate  
    v0: ParameterEstimate  
    kappa: ParameterEstimate  
    theta: ParameterEstimate  
    sigma_v: ParameterEstimate 
...
class GARCHParameters:
    ...
    """
    mu: ParameterEstimate  
    omega: ParameterEstimate  
    alpha: ParameterEstimate  
    beta: ParameterEstimate  
    persistence: ParameterEstimate 
    unconditional_var: ParameterEstimate
