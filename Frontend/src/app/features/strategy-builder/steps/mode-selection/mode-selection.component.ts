    ...
    <div class="max-w-4xl">
      <div class="mb-8">
        ...
        <p class="text-surface-600">
          Choose whether you're building wealth (accumulation) or planning for retirement (drawdown).
        </p>
      </div>
      ...
      <div class="grid md:grid-cols-2 gap-6">
        ...
        <button
          ...
          class="card p-8 text-left transition-all duration-200"
        >
          ...
          <h3 class="text-xl font-semibold text-surface-900 mb-3">Accumulation</h3>
          ...
          <ul class="space-y-3">
            <li class="flex items-center text-sm text-surface-600">
        ...
        >
          ...
          <h3 class="text-xl font-semibold text-surface-900 mb-3">Retirement</h3>
          <p class="text-surface-600 mb-6">
...
export class ModeSelectionComponent {
  ...
  getModeCardClass(mode: SimulationMode): string {
    ...
    if (isSelected) {
      return 'ring-2 ring-accent-500 border-accent-200 bg-accent-50/30';
    }
    return 'hover:border-surface-300 hover:shadow-medium';
  }
  ...
  getRadioClass(mode: SimulationMode): string {
    ...
    if (this.draft.mode === mode) {
      return `${base} border-accent-500 bg-white`;
    }
    return `${base} border-surface-300 bg-white`;
  }
}